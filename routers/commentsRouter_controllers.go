...
func init() {
	...
	beego.GlobalControllerRouter["resoluciones_docentes_mid/controllers:UserController"] = append(beego.GlobalControllerRouter["resoluciones_docentes_mid/controllers:UserController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           "/",
			AllowHTTPMethods: []string{"post"},
